...
# ==============================================================================
NAMESPACE="lab-apps"
DEPLOYMENT_NAME="manual-dotnet-app"
LOCAL_PORT=8083
CONTAINER_PORT=8080
# ==============================================================================

echo "🚀 Starting Traffic Simulator for Manual .NET App..."
...
while true; do
    ...
    if [ "$RESPONSE" == "200" ]; then
        echo "[$COUNT] ✅ .NET Request Successful (HTTP 200) - Trace sent to Splunk"
    else
        echo "[$COUNT] ❌ .NET Request Failed (HTTP $RESPONSE)"
    fi
    
    # .NET Profiler sometimes needs a few requests to "warm up" and start reporting
    sleep 2
done
